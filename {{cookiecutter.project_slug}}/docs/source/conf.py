...
copyright = u'2016, {{ cookiecutter.author_name }}'
...
release = u'{{ cookiecutter.version }}'
...
#
# html_title = u'{{ cookiecutter.project_name }} v{{ cookiecutter.version }}'
...
man_pages = [
    (master_doc, 'project_name', u'{{ cookiecutter.project_name }} Documentation',
     [author], 1)
]
